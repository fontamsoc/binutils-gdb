...
static bfd_boolean pu32_info_to_howto_rela (
...
static bfd_boolean pu32_elf_relocate_section (
	bfd *output_bfd,
	struct bfd_link_info *info,
	bfd *input_bfd,
	asection *input_section,
...
static bfd_boolean pu32_elf_check_relocs (
	bfd *abfd,
	struct bfd_link_info *info,
	asection *sec,
	...
	reference counting (ie. we don't allow them to create GOT entries). */
...
static bfd_boolean pu32_elf_adjust_dynamic_symbol (
	struct bfd_link_info *info,
	struct elf_link_hash_entry *h) {
...
static bfd_boolean pu32_remove_from_dynamic_symbol_table (
		struct elf_link_hash_entry *h,
		void *data) {
...
static bfd_boolean pu32_elf_size_dynamic_sections (
...
static bfd_boolean pu32_elf_finish_dynamic_symbol (
	bfd *output_bfd,
	struct bfd_link_info *info,
	struct elf_link_hash_entry *h,
...
static bfd_boolean pu32_elf_finish_dynamic_sections (
